...
Divide the traing data into training and test partitions. The test parition will be used to determine the accuracy of different methods used to build prediction models.
```{r echo=TRUE}
...
The plot and cptable show that the tree should not be pruned. The cross-validation error of 0.3972129 + or - the standard deviation (xstd) of 0.005377592 is between 0.4025905 and
...
####prediction mode for the random forest.
